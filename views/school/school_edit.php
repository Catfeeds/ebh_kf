...
<form method="post" action="/school/edit.html" onSubmit="return $(this).form('validate')">
...
<style type="text/css">
body{font-family:tahoma,verdana,arial;line-height:15px;background-color:#FCFDFD;color:#666666;margin-left:20px;}
...
<tr><th>网校logo</th><td><?php $Upcontrol->upcontrol('cface',1,array('upfilepath'=>$c['cface']),'pic');?></td></tr>
<tr>
<th>所属教师<em>*</em><p>请选择网校所属的教师。</p>
</th>
<td><div>
<input type="text" readonly value="<?=$c['username']?>" id="username" name="username">
...
<input type="radio" <?php if($c['isschool']=='3'){echo 'checked=checked';}?> id="isschoolfour" name="isschool" value="3"  /><label for="isschoolfour">学校平台</label>
...
<tr>
	...
	<input type="radio" <?php if($c['grade']=='10'){echo 'checked=checked';}?> id="gradefour" name="grade" value="10"  /><label for="gradefour">高中</label>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<textarea  class="p98" name="summary"  rows="5" id="summary" style="width:350px"><?=$c['summary']?></textarea>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		...
		公司分层
		<input type="text" name="profitratio[company]" value="<?=$pftio['company']?>" style="margin-left:80px">
		</span>
		<br style="clear: both;">
		<span id="ceng_agent">
		代理商分层 
		<input type="text" name="profitratio[agent]" value="<?=$pftio['agent']?>" style="margin-left:66px">
		</span>
		<br style="clear: both;">
...
<tr><th>排序</th><td> <input type="text" class="w50" maxlength="50" name="displayorder" id="displayorder" value="<?=$c['displayorder']?>"style="width:300px"></td></tr>
...
<tr><th>冻结金额时间</th><td><input type="text" maxlength="10" style="width:10em;" id="fund_freeze" name="fund_freeze" value="<?=$c['fund_freeze']?>"<?php if(empty($c['freeze_editable'])) { ?> readonly="readonly"<?php } ?> />&nbsp;天</td> </tr>
</table>
</div>
<div class="buttons">
...
$(function(){
    ...
    $('#fund_freeze').validatebox({
        required:true,
        missingMessage:'请填写金额冻结时间',
        validType: 'isnum',
        invalidMessage:'金额冻结时间必须为正整数'
    });
